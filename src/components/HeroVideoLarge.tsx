const HeroVideoLarge = (props: any) => {
  return (
    <section className="mx-auto max-w-8xl">
      <div className="gap-3 relative">
        <video src={props.videoSrc} className="w-full h-180 object-cover object-center" autoPlay muted loop></video>
